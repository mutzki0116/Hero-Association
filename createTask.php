<?php  
	...
	if(isset($_POST['submitbutton'])){
		...
		$taskQuery = "INSERT INTO hero_tasks(task_threat_level,task_city, task_monster,task_name,task_to, task_description, task_status) VALUES(:tasklvl, :taskcity, :taskmonster, :taskto, :taskdesc, :taskstatus);";
